        ...
        <Col md={6}>
          <h2
              ...
              <div style={{ lineHeight: "1.8", fontSize: "1rem" }}>
                ...
                <p>
                  <strong>Địa chỉ:</strong> 600 Nguyễn Văn Cừ nối dài, An Bình,
                  Ninh Kiều, Cần Thơ
                </p>
                <hr />
                <p style={{ fontStyle: "italic", color: "#555" }}>
                  <strong>Tiêu chí:</strong> Trang web mang đến trải nghiệm sự kiện
                  năng động hiện đại và đầy cảm hứng — nơi bạn dễ dàng kết nối, khám phá và tham gia những hoạt động bùng nổ cùng <strong>F-Active!</strong>
                </p>
              </div>
        </Col>
